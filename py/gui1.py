...
if __name__ == '__main__':
    ...
    helpLbl = tkinter.Message(helpLf, text="Please type or choose URL to process! Please type or choose URL to process! Please type or choose URL to process! Please type or choose URL to process!")
    helpLbl.grid(row=0)
